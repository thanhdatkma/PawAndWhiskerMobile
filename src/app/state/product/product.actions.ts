...
export const ProductActions = createActionGroup({
  ...
  events: {
    ...
    'Load Products Flash Sale': emptyProps(),
    'Load Products Flash Sale Success': props<{ products: ProductBriefModel[] }>(),
    'Load Products Flash Sale Failure': props<{ error: string }>(),
